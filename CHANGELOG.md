...
### Dependencies
- **ch.admin.bit.jeap:jeap-bptestagent-api**: 7.0.1 → 7.1.0 (minor)
...
### Dependencies
- **ch.admin.bit.jeap:jeap-bptestagent-api**: 6.0.0 → 6.1.0 (minor)

## [10.0.0] - 2026-07-22

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 37.0.0 → 37.2.0 (minor)
- **ch.admin.bit.jeap:jeap-bptestagent-api**: 5.5.0 → 6.0.0 (major)
...
- **ch.admin.bit.jeap:jeap-bptestagent-api**: 5.0.0 → 5.1.0 (minor)
...
### Dependencies
- **ch.admin.bit.jeap:jeap-bptestagent-api**: 4.3.1 → 5.0.0 (major)

## [7.0.0] - 2026-06-30

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 35.11.1 → 36.1.0 (major)
- **ch.admin.bit.jeap:jeap-bptestagent-api**: 4.3.0 → 4.3.1 (patch)

## [6.4.1] - 2026-06-29

### Dependencies
- **ch.admin.bit.jeap:jeap-bptest-orchestrator-parent**: 6.4.0-SNAPSHOT → 6.4.0 (patch)
- **ch.admin.bit.jeap:jeap-bptest-orchestrator-parent**: 6.4.0-SNAPSHOT → 6.4.0 (patch)
